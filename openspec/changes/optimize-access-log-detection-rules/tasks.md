...
- [x] 3.4 Emit compact grouped findings with severity, confidence reason, severity reason, matched indicators, count, source context, target path, and bounded representative evidence.
